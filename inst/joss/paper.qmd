...
which considers the morphology of the urban fabric and the morphology of 
the river valley jointly. CRiSp automates that method of delineation, 
while leveraging local and global spatial-temporal big data (e.g., 
OpenStreetMap and Global DEM data) increasingly available for riverspace 
analysis at large [@forgaci2020]. The automation of the delineation is
