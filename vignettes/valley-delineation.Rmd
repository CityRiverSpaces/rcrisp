...
In this article, we describe how `delineate_valley()` works and how it can be used independently. `delineate_valley()` uses a Cost Distance algorithm, variants of which are mostly used for the delineation of wet area mapping and valley bottom delineation in non-urban contexts [@agren2014; @white2012].
...
#| fig.cap: "Digital Elevation Model of the area enclosing River Dâmbovița in Bucharest"
plot(dem)
