...
We demonstrate valley delineation using data from CRiSp example data, namely the DEM of Bucharest as the input raster and the river centerline and surface as the source for which the Cost Distance is calculated.
