...
#' @srrstats {G1.0} This vignette provides a publication describing an early version of the method implemented in the package.
#' @srrstatsTODO {G1.1} It is specified here that `rcrisp` is the first implementation of a novel algorithm.
```
