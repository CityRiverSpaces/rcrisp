...
2. The urban **corridor** surrounding the river is delineated on the street network along a path following road centerlines that is closest to the valley edge, as shown in `vignette("corridor-delineation")`.
