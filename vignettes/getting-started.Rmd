...
`rcrisp` automates the morphological delineation of riverside urban areas following a method developed by @forgaci2018. It overcomes the challenge of arbitrary urban river corridor delineation by providing a reliable workflow to produce morphologically grounded spatial analytical units.
...
2. Delineate the river valley, corridor, segments and/or riverspace with the
   all-in-one `delineate()` function or with the dedicated `delineate_*()`
   functions
3. Visualize, validate, and export results
