...
#' @srrstats {G1.0} This vignette provides several literature references used for the method of valley delineation.
#' @srrstats {G1.3} Literature references are given for the Cost Distance algorithm used for valley delineation.
```
