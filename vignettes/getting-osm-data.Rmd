...
city_boundary <- st_read(here("data/generated/city_boundary_Bucharest.gpkg"))
waterway <- st_read(here("data/generated/waterway_Bucharest.gpkg"))
waterbody <- st_read(here("data/generated/waterbody_Bucharest.gpkg"))
highways_lines <- st_read(here("data/generated/highways_Bucharest.gpkg"))
railways_lines <- st_read(here("data/generated/railways_Bucharest.gpkg"))
```
...
purrr::walk(
    ...
    ~ st_write(
        .x,
        dsn = sprintf(here::here("data/generated/%s_%s.gpkg"), 
