...
To demonstrate this as a separate step, we will use the `bucharest_delineation$corridor` from the package data, as well as `bucharest_osm$streets` and `bucharest_osm$railways` from rcrisp example data as input.
...
segmented_corridor <-
  delineate_segments(bucharest_delineation$corridor,
                     network_filtered,
