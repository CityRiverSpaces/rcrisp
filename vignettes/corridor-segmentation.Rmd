...
To demonstrate this as a separate step, we will use the `bucharest_delineation$corridor` from the package data, as well as `bucharest_osm$streets` and `bucharest_osm$railways` from CRiSp example data as input.
