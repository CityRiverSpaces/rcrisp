...
#' @srrstats {G2.0, G2.0a} Assertions are implemented throughput the package for
#'   exported functions which require single- or multi-valued input using the
#'   `checkmate` package. It is made explicit in the descriptions of such
#'   parameters that they should be of the required length.
