test_that("STAC asset urls are correctly retrieved", {
  ...
  asset_urls_retrieved <- get_stac_asset_urls(bb, endpoint = ep, collection = col)
  asset_urls_retrieved_default <- get_stac_asset_urls(bb)

  expected_asset_urls <- c("s3://copernicus-dem-30m/Copernicus_DSM_COG_10_N44_00_E026_00_DEM/Copernicus_DSM_COG_10_N44_00_E026_00_DEM.tif",
  "s3://copernicus-dem-30m/Copernicus_DSM_COG_10_N44_00_E025_00_DEM/Copernicus_DSM_COG_10_N44_00_E025_00_DEM.tif")
...
test_that("raster data are correctly retrieved and merged", {
  skip_on_ci()
  bb <- osmdata::getbb("Bucharest")
  raster_paths <- c("s3://copernicus-dem-30m/Copernicus_DSM_COG_10_N44_00_E026_00_DEM/Copernicus_DSM_COG_10_N44_00_E026_00_DEM.tif",
  "s3://copernicus-dem-30m/Copernicus_DSM_COG_10_N44_00_E025_00_DEM/Copernicus_DSM_COG_10_N44_00_E025_00_DEM.tif")
...
test_that("valley polygon is correctly constructed", {
  ...
  expected_valley <- st_read("path_to_example_valley") #TODO add example valley and path
