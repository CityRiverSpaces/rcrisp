...
- Get started (purpose & workflow): `vignette("getting-started", package = "rcrisp")`
...
See the [Getting started vignette](https://cityriverspaces.github.io/rcrisp/articles/getting-started.html) for an end-to-end example, data requirements, and indication of use cases.
